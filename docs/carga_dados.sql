...
insert into categoria (id, descricao) values (1, 'Informática');
insert into categoria (id, descricao) values (2, 'Eletrodomésticos');
insert into categoria (id, descricao) values (3, 'Móveis');
